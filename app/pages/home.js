  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.header}>
        <Text style={styles.logo}>InmiJobs</Text>
        <View style={styles.headerIcons}>
          <TouchableOpacity style={styles.iconCircle}><Ionicons name="search" size={20} /></TouchableOpacity>
          <TouchableOpacity style={styles.iconCircle}><Ionicons name="chatbubble-ellipses" size={20} /></TouchableOpacity>
        </View>
      </View>
        ...
        ListHeaderComponent={() => (
          ...
          <View style={styles.inputSection}>
            ...
            <View style={styles.inputFake}>
              <Text style={{ color: '#65676b' }}>¿Qué estás pensando?</Text>
            </View>
          </View>
        )}
      />
