...
import GestionPortafolio from './GestionPortafolio';
...
function CustomDrawerContent(props) {
  ...
  <DrawerItem
    label="Map"
    icon={({ color, size }) => <Ionicons name="map" color={color} size={size} />}
  ...
  return (
    <>
      ...
      >
        ...
        <Drawer.Screen name="Portafolio" component={GestionPortafolio} initialParams={params} />
