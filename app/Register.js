      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 100 }}>
        ...
        >
          ...
          <View style={{ backgroundColor: 'white', padding: 30, borderTopLeftRadius: 40, borderTopRightRadius: 40 }}>
            <Text style={{ fontSize: 24, fontWeight: 'bold', textAlign: 'center', marginBottom: 25 }}>Register</Text>
            ...
            <View style={{width: 320,marginTop: 20,display: "flex",flexDirection: "row",justifyContent: "center",alignItems: "center",}}>
                ...
                <TouchableOpacity onPress={() => router.replace("/Login")}>
                    <Text style={{color: "#0661BC",fontFamily: "roboto",fontWeight: "bold",fontSize: 16, textDecorationLine: "underline",}}>Inicia Sesion aquí</Text>
                </TouchableOpacity>
                </View>
